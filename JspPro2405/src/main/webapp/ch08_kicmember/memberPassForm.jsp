	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" novalidate  method="post"    action="memberPassPro.jsp">
				
					<div class="row">
						<div class="col-md-6 mb-3">
							<label for="id">아이디</label> <input type="text" readonly
								class="form-control" id="id" placeholder="" value="<%=session.getAttribute("id")%>" name="id"  >
						...
						<div class="col-md-6 mb-3">
							<label for="pass">현재 비밀번호</label> <input type="password"
								class="form-control" id="pass" placeholder="현재 비밀번호" value=""  name="pw" 
								required>
							<div class="invalid-feedback">비밀번호을 입력해주세요.</div>
						</div>
											<div class="col-md-6 mb-3">
							<label for="pass">새로운 비밀번호</label> <input type="password"
								class="form-control" id="pass" placeholder="새로운 비밀번호" value=""  name="newPw" 
								required>
							<div class="invalid-feedback">새로운 비밀번호을 입력해주세요.</div>
						</div>
					</div>
