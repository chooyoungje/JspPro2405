					   ...
					   <div class="col-md-3 mb-3">
						...
						<div class="col-md-6 mb-3">
							<label for="id">아이디</label> <input type="text" readonly
								class="form-control" id="id" placeholder="아이디" value="<%=id %>" required  name="id">
						...
						<div class="col-md-6 mb-3">
							<label for="pass">비밀번호</label> <input type="password"
								class="form-control" id="pass" placeholder="아이디" value="<%=mem.getPw() %>" required  name="pw">
						...
						<div class="col-md-6 mb-3">
							<label for="gender">남자</label> <input type="radio"
								 id="gender1"  value="1" <%= mem.getGender()==1 ? "checked" : "" %> required  name="gender" >
						
						</div>
						<div class="col-md-6 mb-3">
							<label for="gender">여자</label> <input type="radio"
								 id="gender2" placeholder="" <%= mem.getGender()==2 ? "checked" : "" %>" value="2"   name="gender"
								required>
						</div>
					</div>
